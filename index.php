            ...
            <div class="main-header__container container">
                ...
                <nav class="user-menu">
                    ...
                    <div class="user-menu__image">
                        <img src="<?= $user_avatar?>" width="40" height="40" alt="User photo">
                    </div>
                ...
                <ul class="lots__list">
                    ...
                    <li class="lots__item lot">
                        ...
                        <div class="lot__info">
                            ...
                            <h3 class="lot__title">
                                <a class="text-link" href="lot.html"><?=$value['title']?></a>
                            </h3>
            ...
            <div class="main-footer__bottom container">
                ...
                <div class="main-footer__social social">
                    ...
                    <a class="social__link social__link--twitter" href="#">Twitter
                        <svg width="27" height="27" viewbox="0 0 27 27" xmlns="http://www.w3.org/2000/svg"><circle stroke="#879296" fill="none" cx="13.5" cy="13.5" r="12.687"/><path
                            fill="#879296"
                    ...
                    <a class="social__link social__link--vkontakte" href="#">Вконтакте
                        <svg width="27" height="27" viewbox="0 0 27 27" xmlns="http://www.w3.org/2000/svg"><circle stroke="#879296" fill="none" cx="13.5" cy="13.5" r="12.666"/><path
                            fill="#879296"
